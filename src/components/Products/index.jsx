...
import prd3 from '../../assets/img/prd3.jpg'
import prd4 from '../../assets/img/prd4.jpg'
...
export default function Products({handleAddToCart}) {
  const products =[
    ...
    {
      id: 2, productName: 'Đồng hồ FREDERIQUE CONSTANT', productImg: prd2, price: 55913000, description: 'Thiết kế nam tính, tạo nên phong thái đĩnh đạc cho quý ông đến từ hãng đồng hồ Frederique Constant ra đời tại Thụy Sĩ.'
    },
    {
      id: 3, productName: 'Đồng hồ Edox CO-1', productImg: prd3, price: 32130000, description: 'Đồng hồ Edox CO-1 45 mm Nam 10242-TINRCA-BRDR là một lựa chọn hoàn hảo cho những người đàn ông yêu thích sự mạnh mẽ và cá tính, khi sở hữu một thiết kế đậm chất thể thao và đầy mạnh mẽ.'
    },
    {
      id: 4, productName: 'Đồng hồ Orient Mako Solar', productImg: prd4, price: 7005000, description: 'Đồng hồ Orient Mako Solar 42.8 mm Nam RA-TX0201L10B thuộc thương hiệu Orient của Nhật Bản.'
    },
  ]
  return (
